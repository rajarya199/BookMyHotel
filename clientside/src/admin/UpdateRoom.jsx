...
const UpdateRoom = () => {
  ...
  const{room_title,room_number,room_type,room_price,room_description,room_facility,maxguest,hotel}=roomData
...
const [error,setError]=useState('')
  ...
  useEffect(()=>{
    ...
    .then(res=>{
        ...
        setRoomData({
            ...
            room_description:res.data.room_description,
            hotel:res.data.hotel,
            maxguest:res.data.maxguest,
            room_facility:res.data.room_facility,
            room_image:res.data.room_image
        })
 ...
 const handleSubmit=async event=>{
  ...
  await axios.put(`${API}/updateroom/${id}`,formData,config)
  setSuccess(true)
  setError('')
//   setRoomData({
//     room_title:'',
        ...
        <div className="row d-flex justify-content-center mb-10">
          <div className="col-md-10">
            <form className="shadow p-3">
              <h3 className="text-center text-2xl ">Update Room</h3>
              {showError()}
                            {showSuccess()}
              <div className="mb-2">
