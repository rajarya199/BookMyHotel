...
// const handleChangeAmenity=infm=>e=>{
...
//     setHtldata({
//       ...htldata,
//       htl_amnities:e.target.value
//   }) 
//   }
//   //unchecked item
//   else{
//     //remove unchecked item
//     setHtldata(htl_amenities.filter((e)=>(e !== value)))
...
const handleSubmit=async event=>{
  ...
  try{
    ...
    await axios.post(`${API}/posthotel`,formData,config)
    setSuccess(true)
        setError(false)
        setHtldata({
          htl_name:'',
        ...
        <div className="row d-flex justify-content-center mb-10">
          <div className="col-md-10">
            <form className="shadow p-3">
              <h3 className="text-center text-2xl ">Add Hotel</h3>
              {showError()}
                {showSuccess()}
              <div className="mb-2">
